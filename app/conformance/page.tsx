...
export const metadata: Metadata = {
  ...
  description:
    "AXL defines three conformance levels — L1 Functional, L2 Production, L3 Reference. L1 and L2 are self-attested; L3 is verified by axl.org and is the prerequisite for the AXL™ certification mark.",
};
  ...
  return (
    <DocPage
      ...
      meta={[
        ...
        { label: "Process owner", value: "axl.org editorial board" },
      ]}
    >
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Verified review by axl.org against the full specification.</td>
      ...
      <p>
        A Conformance Statement is a public document filed by an implementer attesting to specific clauses of the specification. For L1 and L2, attestation is self-published and does not require axl.org review. The statement must include:
      </p>
      <ul>
      ...
      <div className="callout">
        <p>
          <strong>Conformance Statement template:</strong> a fillable template is published at <code>github.com/axl-spec/spec/blob/main/conformance-statement-template.md</code>. Self-attested statements may be filed by opening a pull request adding the statement to <code>/statements</code>.
        </p>
      </div>

      <h2><span className="num">§ 6.3</span>Verified certification (L3)</h2>
      <p>
        L3 conformance requires verified review by the axl.org reviewer panel. The process is documented at <Link href="/certification">/certification</Link> and entails:
      </p>
      <ol>
        ...
        <li>Publication of the reviewer report at <code>axl.org/certified/[vendor]</code>.</li>
