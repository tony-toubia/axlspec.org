...
The public-facing website for the [AXL Reference](https://axlspec.org/spec/v1.0) — an open specification for the **Agentic Experience Layer** category, stewarded by axl.org. Founding sponsor: Cadence.
